...
const HelpSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        setStatus({ loading: false, success: false, error: data.message || 'Failed to send enquiry' });
        return;
      }
            ...
            <div className="pt-2 space-y-3">
              {status.success && (
                <p className="text-sm text-green-700">
                  Thanks — we've received your enquiry and will respond soon.
                </p>
              )}
              ...
              <button
                ...
                className="bg-[#896D43] hover:bg-[#725935] disabled:opacity-50 text-white font-normal px-8 py-3 rounded-xl text-sm transition-colors duration-200"
              >
