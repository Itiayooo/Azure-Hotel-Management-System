  ...
  return (
    <div className="font-['Mona_Sans',sans-serif] space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
          <span className="text-xs font-medium text-gray-500">Check In (Today)</span>
          <p className="text-2xl font-semibold text-gray-900 tracking-tight mt-2">
            {loading ? '...' : stats.todaysCheckIns}
          </p>
        </div>

        <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
          <span className="text-xs font-medium text-gray-500">Check Out (Today)</span>
          <p className="text-2xl font-semibold text-gray-900 tracking-tight mt-2">
            {loading ? '...' : stats.todaysCheckOuts}
          </p>
        </div>
